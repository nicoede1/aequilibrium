...
node_h1.addService(rspec.Execute(shell="/bin/sh", command="sudo git clone https://github.com/pari685/AStream /opt/"))
node_h2.addService(rspec.Execute(shell="/bin/sh", command="sudo git clone https://github.com/pari685/AStream /opt/"))
node_h3.addService(rspec.Execute(shell="/bin/sh", command="sudo git clone https://github.com/pari685/AStream /opt/"))
